...
import TempEmailLoginComponent from "./TempEmailLoginComponent";
...
//로그인 컴포넌트
const TempEmailLogin = ({ history, location, match }) => {
  ...
  return (
    <div>
      ...
      <Responsive as={Grid} style={{ margin: 0 }} maxWidth={1080}>
        ...
        >
          <TempEmailLoginComponent history={history} />
        </Grid.Column>
      </Responsive>
